...
def main():
    ...
    parser.add_argument('-W', '--width', type=positive_int, help="Width of the forest", default=96)
    parser.add_argument('-H', '--height', type=positive_int, help="Height of the forest", default=72)
